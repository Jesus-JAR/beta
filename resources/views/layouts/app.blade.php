...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Page Heading -->
        @if (isset($header))
            <header class="bg-white shadow pb-20">
    ...
    <script type="text/javascript"
        src="https://cdn.datatables.net/v/bs5/jszip-2.5.0/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/r-2.3.0/datatables.min.js">
    </script>
</body>
