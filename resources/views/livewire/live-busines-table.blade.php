                                ...
                                <tr>
                                    <th class="px-4 py-2">
                                        <div class="flex items-center cursor-pointer w-10">
                                            ...
                                            <span
                                                class="ml-2 fa fa-{{ $camp === 'id' ? $icon : 'circle' }} text-gray-500 cursor-pointer"></span>
                                        </div>
                                    </th>
                                    <th class="px-4 py-2">
                                        <div class="flex items-center cursor-pointer w-20">
                                            ...
                                            <span
                                                class="ml-2 fa fa-{{ $camp === 'name' ? $icon : 'circle' }} text-gray-500"></span>
                                        </div>
                                    </th>
                                    <th class="px-4 py-2">
                                        <div class="flex items-center cursor-pointer ">
                                            ...
                                            <span
                                                class="ml-2 fa fa-{{ $camp === 'address' ? $icon : 'circle' }} text-gray-500"></span>
                                        </div>
                                    </th>
